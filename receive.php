<?php
			...
			$post_data = array (
				"requests" => array (
						array (
							"image" => array (
								"source" => array (
									"imageUri" => "http://139.59.123.8/chtChatBot/JamesYen_LineBot/".$objID.".jpeg"
								)
							),
							"features" => array (
								array (
	...
	//回傳給line server
	$header[] = "Content-Type: application/json";
	$header[] = "Authorization: Bearer usKtkP3/syVWHqYd3ZMgjcG3xR3jf9tCquF9Sm75xgDKT04OXRZxtaJl19I5WM0UIWHt3Y5bbrEUSjAuMkW38+MLvTdqfqCsI5RiFDI57WJyOus7PcszC6+xQOtRz5wlYmFf2sepskoqf9gmaU9TIgdB04t89/1O/w1cDnyilFU=";
